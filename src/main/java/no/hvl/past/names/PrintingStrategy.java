...
public interface PrintingStrategy {
    ...
    class DefaultPrintingStrategy implements PrintingStrategy {
        ...
        public DefaultPrintingStrategy(boolean ignorePrefix, boolean putParanthesis) {
            this.ignorePrefix = ignorePrefix;
            this.putParanthesis = putParanthesis;
        }
    ...
    class LatexPrintingStrategy extends DefaultPrintingStrategy {
        ...
        public LatexPrintingStrategy(boolean ignorePrefix, boolean putParanthesis, boolean mathematicalOrder) {
            super(ignorePrefix, putParanthesis);
    ...
    PrintingStrategy IGNORE_PREFIX = new DefaultPrintingStrategy(true, false);
    PrintingStrategy DETAILED = new DefaultPrintingStrategy(false, true);
